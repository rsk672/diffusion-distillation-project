    ...
    def __init__(
        ...
        *,
        ...
        if self.resume_step:
            ...
            logger.log('resume step')
        else:
            logger.log('deepcopying ema params from trainer model!')
            self.ema_params = [
        ...
        if th.cuda.is_available():
            print('cuda is available, doing ddp thing')
            self.use_ddp = True
            ...
            self.use_ddp = False
            self.ddp_model = self.model.to(dist_util.dev())

        self.step = self.resume_step
        print('INIT TRAIN LOOP END')
